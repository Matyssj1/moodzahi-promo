  ...
  return (
    ...
    >
      <body className="relative min-h-full flex flex-col">
        ...
        {/* --- GOOGLE ANALYTICS (Solo si se configuró un ID real) --- */}
        {process.env.NEXT_PUBLIC_GA_ID && process.env.NEXT_PUBLIC_GA_ID !== "G-XXXXXXXXXX" && (
          <GoogleAnalytics gaId={process.env.NEXT_PUBLIC_GA_ID as string} />
        )}

        {/* --- MICROSOFT CLARITY --- */}
        {/* --- MICROSOFT CLARITY (Solo si se configuró un ID real) --- */}
        {process.env.NEXT_PUBLIC_CLARITY_ID && process.env.NEXT_PUBLIC_CLARITY_ID !== "TU_CLARITY_ID" && (
